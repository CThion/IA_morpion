...
__date__ = "19.02.21"
__usage__ = "Project 2022: tests jalon 03: IterativeDeepening"
__update__ = "06.03.22"
...
class TestDefault(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.o = self.K('x', self.jeu, pf=3, secondes=.1)
...
class TestMatches(unittest.TestCase):
    ...
    def test_take_last(self, mock_prn):
        ...
        o = self.K('x', jeu, pf=3, secondes=.1)
...
class TestBoxes(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.K = getattr(tp, THAT)
        self.K.decision.memory = {}
        self.o = self.K('x', jeu, pf=3, secondes=.1)
...
class TestHexaPawn(unittest.TestCase):
    ...
    def test_attak(self, mock_prn):
        ...
        _0 = "X.."+"O.X"+".O.",4
        for pf in pfl:
            o = self.K('bidon', self.jeu, pf=pf, secondes=.1)
...
class TestMorpion(unittest.TestCase):
    ...
    def test_blind_spot(self, mock_prn):
        ...
        _0 = "X..O."+"."*5+"..XO."*2+'.'*5, 6
        o = self.K('bidon', self.jeu, pf=1, secondes=.1)
        o.who_am_i = self.jeu.turn
        _val = o.decision(_0)
        _1 = o.game.actions[0]
...
class TestMemory(unittest.TestCase):
    ...
    def test_subkeys_values(self, mock_prn):
        ...
        self.assertEqual(_1, 3,
                         "decision should return 3, found {}".format(_1))
        _memory = self.K.decision.memory
        self.assertEqual(len(_memory), 5)
        _good = [ [0, True, 100, None], [1, True, -100, 1],
                  [2, True, 100, 1], [2, True, 100, 2],
                  [3, True, 100, 3] ]
        for i in range(5):
    ...
    ## This part should be enabled only if reordering heuristic
    ## has been made
    #@patch('builtins.print')
